    ...
    <div class="flex h-max mx-2">
        <div class="grid left-0 flex-row-reverse">
            ...
            <div class="transition-all duration-700 bg-neutral-200 overflow-hidden flex justify-center rounded-lg"
                ...
                <div class="w-60 grid">
                    <div
                        class="w-56 hidden md:block transition-all duration-700 relative h-[calc(100vh-2rem)] max-w-[20rem] flex-col rounded-xl bg-clip-border text-gray-700">
                        <div class="p-4 mb-2 mx-auto w-max ">
                            <svg class=" mx-auto fill-gray-700" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="_x32_" width="70px"
                                height="70px" viewBox="0 0 512 512" xml:space="preserve">
                                <g>
                                    <path class="st0"
                            ...
                            <h5
                                class="font-sans text-xl text-center antialiased font-extrabold tracking-normal text-blue-gray-900">
                                {{ user.fullName }}
                            </h5>
                        </div>
                        <nav
                            ...
                            <div class="relative block w-max">
                                <div role="button"
                                    ...
                                    <button @click="category()"
                                        ...
                                        <span class="ml-4">
                                            <svg :class="{ 'rotate-180': listCategory }"
                                ...
                                <div class="overflow-hidden">
                                    <div
                                        class="block w-max py-1 font-sans text-sm antialiased font-light leading-normal text-gray-700">
                            ...
                            <div class="relative block w-max">
                                <div role="button"
                                    ...
                                    <button @click="sort()"
                                        ...
                                        <span class="ml-4">
                                            <svg :class="{ 'rotate-180': sortNav }" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div
                                        ...
                                        <nav v-if="sortNav"
                                            ...
                                            <div role="button" @click="sortRating()"
                                                ...
                                                <svg :class="{ 'rotate-180': !ascRating }"
                                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="2.5" stroke="currentColor" aria-hidden="true"
                                                    class="w-4 h-4 transition-transform">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <router-link to="/cart"
                                ...
                                <div class="grid mr-4 place-items-center">
                                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        viewBox="0 0 133.865 133.865" xml:space="preserve">
                                        <g>
