      ...
      <div class="grid grid-cols-12">
        ...
        >
          ...
          >
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 w-full">
              ...
              <div
                class="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-6 h-full"
              >
                <p
          ...
          <div class="flex items-center mt-8">
            ...
            >
              <svg
                class="transition-all duration-500 group-hover:translate-x-2 rotate-180"
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="22"
                viewBox="0 0 22 22"
        ...
        >
          ...
          <div class="mt-8">
            ...
            <div>
              <div
                class="max-w-sm mx-auto grid items-center border-b border-gray-200 my-2"
              >
                <label
              ...
              <div
                v-if="alamat"
                class="ml-3 flex items-center justify-between py-2"
              >
