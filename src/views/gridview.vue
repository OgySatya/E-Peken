          ...
          <div class="mt-2 mb-5 flex items-center justify-between">
            ...
            <div class="grid">
              <div class="flex items-center">
                <svg aria-hidden="true" class="h-6 w-6 text-yellow-300" fill="currentColor" viewBox="0 0 20 20"
                ...
                <span class="mr-2 rounded bg-yellow-200 px-2.5 py-0.5 text-xs font-semibold">{{ product.rating.rate
                  }}</span>
              </div>
              <p class="font-medium text-xs text-gray-900 underline hover:no-underline text-center">
                Reviews
