  ...
  <div class="flex w-10/12 mx-auto">
    ...
    <div v-if="sideOpen"
      ...
      <div class="p-4 mb-2 mx-auto">
        ...
        <h5 class="block font-sans text-xl antialiased font-extrabold leading-snug tracking-normal text-blue-gray-900">
          {{ user.fullName }}
        </h5>
      </div>
    ...
    <div class="w-max">
      ...
      <div class="flex my-4">
        <button class="mr-4" @click="grid()">
          <svg class="w-10 h-10 text-gray-800 rounded" :class="{ 'fill-gray-300 border-2 border-gray-500': view }"
        ...
        <button @click="list()">
          <svg class="w-10 h-10 text-gray-800 rounded" :class="{ 'fill-gray-300 border-2 border-gray-500': !view }"
            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="28" fill="none"
            viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
