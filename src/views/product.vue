...
function sortName() {
  ...
  if (ascName.value === true) {
    allProduct.value = filteredName.value
      .slice()
...
const filteredName = computed(() => {
  return allProduct.value.filter((name) =>
    name.title
...
function addCart(product) {
  if (!store.cartData.some((item) => item.title === product.title)) {
    ...
    const index = store.cartData.findIndex(
...
<template>
  <div class="flex w-11/12 mx-auto">
    <div
      v-if="sideOpen"
      class="hidden md:block transition-all duration-700 relative h-[calc(100vh-2rem)] w-fit max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-2 text-gray-700"
    >
      <div class="p-4 mb-2 mx-auto">
        <svg
          class="mx-auto fill-gray-700"
      ...
      <nav
        class="flex min-w-[200px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700"
      >
        <div class="relative block w-fit">
          ...
          <div class="overflow-hidden">
            <div
              class="block w-fit py-1 font-sans text-sm antialiased font-light leading-normal text-gray-700"
            >
              <nav
                v-if="listCategory"
        ...
        <div class="relative block w-fit">
          ...
          >
            ...
            >
              ...
              <p
                class="block mr-auto font-sans font-bold text-xl antialiased leading-relaxed text-blue-gray-900"
              >
                Sort By
              </p>
              <span class="ml-4">
                <svg
                  :class="{ 'rotate-180': sortNav }"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="2.5"
    ...
    <div class="w-full">
        ...
        <div class="flex justify-between">
          ...
          <div class="hidden md:block">
            <button class="mr-4" @click="grid()">
              <svg
                class="w-10 h-10 text-gray-800 rounded"
                :class="{ 'fill-gray-300 ring': view }"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
      ...
      <section class="w-full flex">
        <ul v-if="view" class="grid grid-cols-3 gap-4 mx-auto">
          ...
          >
            ...
            >
              ...
              <h5
                class="h-12 text-md font-semibold text-wrap text-gray-900 overflow-hidden text-ellipsis"
              >
                {{ product.title }}
              </h5>
            </RouterLink>
            <div>
              <div class="flex items-center">
                ...
                <span
                  class="w-1 h-1 mx-1.5 bg-gray-500 rounded-fit dark:bg-gray-400"
                ></span>
                <p
            ...
            <div class="flex justify-between my-auto">
              ...
              <button
                ...
                class="text-white text-xs bg-blue-700 rounded-md p-1 px-3 text-center"
              >
                Add
        ...
        <div v-else class="relative overflow-x-auto mx-auto">
          <table
            class="text-sm text-left rtl:text-right text-gray-700 dark:text-gray-400 mx-auto"
          >
            <thead
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  <button
                    @click="addCart(product)"
                    class="text-gray-900 text-xs bg-gray-100 rounded-lg p-1 px-3 -mt-10 text-center"
                  >
                    Add
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
      ...
      <nav class="w-3/4 mt-5 mx-auto">
        <ul class="flex justify-between text-lg font-bold">
          <li>
            <button
              @click="previousPage()"
              class="relative block rounded bg-transparent px-3 py-1.5 text-surface transition duration-300 hover:bg-neutral-100 focus:bg-neutral-100 focus:text-primary-700 focus:outline-none focus:ring-0 active:bg-neutral-100 active:text-primary-700"
            >
              Previous
            </button>
          </li>
