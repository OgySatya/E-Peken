...
<div class="flex w-10/12 mx-auto">
  ...
  <nav class="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
    ...
    <div role="button"
      ...
      <div class="grid mr-4 place-items-center">
        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" viewBox="0 0 133.865 133.865" xml:space="preserve">
<g>
